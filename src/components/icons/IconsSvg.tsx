...
export const JenkinsLogo = (props: SVGProps<SVGSVGElement>) => (
    <svg
...
export const ModerationIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
        height="16"
